	...
	<form>
		...
		<table border="1">
			...
			<tr>
				...
				<td><%=rs.getString("route_no")%><input type="hidden" name="route_no" value="<%=rs.getString("route_no")%>"></td>
				<td><%=rs.getString("transit_no")%><input type="hidden" name="transit_no" value="<%=rs.getString("transit_no")%>"></td>
